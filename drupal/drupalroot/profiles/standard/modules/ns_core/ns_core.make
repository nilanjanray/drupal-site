...
projects[email][download][revision] = 95d1359
...
; We need to use a later version of entity reference to avoid issues with partial views implementation.
projects[entityreference][type] = module
projects[entityreference][version] = 1.x-dev
projects[entityreference][download][type] = git
projects[entityreference][download][revision] = 58dc93c
...
projects[email][patch][] = http://drupal.org/files/email-contact_form_formater-1264210-17.patch
